...
def main(input_dir, param_files, fixed_img, moving_img):
    ...
    #registrator_object = Registrator(param_files)
    ...
    save_transform_parameters(result_transform_parameters, param_files)
...
def save_transform_parameters(result_transform_parameters, parameter_files_str):
    param_list = parameter_files_str.split(',')
